...
describe("TTLock phase10 release audit", () => {
  ...
  it("p10-1: server-only config", () => {
    ...
    assert.equal(envExample.includes("your-cron-secret"), false);
  ...
  it("p10-6: migrations + db ready probe", () => {
    ...
    const ordered = [
      "20260829120000_ttlock_integration",
      "20260829140000_ttlock_db_phase4",
      "20260830100000_ttlock_access_phase7",
      "20260830120000_ttlock_remote_phase8",
      "20260830140000_ttlock_callback_phase9",
      "20260830160000_ttlock_callback_hardening",
    ];
