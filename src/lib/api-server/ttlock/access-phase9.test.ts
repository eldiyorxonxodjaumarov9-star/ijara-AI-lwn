...
const phase9Sql = readFileSync(
  join(
    repoRoot,
    "server/prisma/migrations/20260830140000_ttlock_callback_phase9/migration.sql"
  ),
  "utf8"
);
const hardeningSql = readFileSync(
  join(
    repoRoot,
    "server/prisma/migrations/20260830160000_ttlock_callback_hardening/migration.sql"
  ),
  "utf8"
);
